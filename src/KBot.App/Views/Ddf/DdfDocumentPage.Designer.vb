...
Partial Class DdfDocumentPage
    ...
    Private Sub InitializeComponent()
        ...
        '
        ' lblAvizSetari — banda de avertizare a setărilor Adobe (o salvare eșuată). Ascunsă cât
        ' timp nu are ce spune. Andocată SUS, deci adăugată ULTIMA (regula casei: într-un
        ' container, copiii se adaugă în ordine INVERSĂ de andocare).
        '
        lblAvizSetari.AutoSize = False
        lblAvizSetari.Dock = DockStyle.Top
        lblAvizSetari.Height = 28
