...
Public Class MainFormNavItemsTests
    ...
    ' InitializeComponent plus field assignments (no null guards), so the six dependencies can be
    ...
    Public Sub Designer_AuthorsTheEightNavEntries_InOrder()
        RunSta(Sub()
                   Using f As New KbotForm(Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing)
