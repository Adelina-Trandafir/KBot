...
Partial Public Class Tree
    ...
    Private Function LoadXmlData(filePath As String, Optional isReload As Boolean = False) As Boolean
        ...
        Try
            ...
            ' Aliniaza coloanele la nivelul primului root chiar de la incarcare
            If _treeListView AndAlso MyTree.Items IsNot Nothing AndAlso MyTree.Items.Count > 0 Then
                MyTree.ApplyDynamicColumns(MyTree.Items(0))
            End If
    ...
    Private Function AddXmlConfigToTree(cfg As XmlNode, Optional Reload As Boolean = False) As Boolean
        Try
            ...
            TreeXmlAppliers.Apply_TooltipShowOnlyOnLeftIcon(cfg, MyTree)
            ...
            TreeXmlAppliers.Apply_SearchClearButton(cfg, MyTree)
            ...
            TreeXmlAppliers.Apply_DynamicColumns(cfg, MyTree)
            TreeXmlAppliers.Apply_ColumnsLevel(cfg, MyTree)
