...
**Slice 0004** (see `KBOT_STATUS.md`). Worklog: `docs/worklog/SLICE-0004-tier1-hardening.md`
(sub-number per pass if done in stages). Read `CODE_WORKFLOW.md` before starting.
...
Not complete until: code builds clean AND a worklog exists at
`docs/worklog/SLICE-0004-tier1-hardening.md` (what changed and why · files touched · test
results · anything left unverified or deferred) AND `KBOT_STATUS.md` is updated AND all
